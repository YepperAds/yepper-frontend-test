...
//     try {
//       await axios.get(`https://yepper-backend.onrender.com/api/auth/verify-email?token=${token}`);
//       setStatus('success');
...
//     try {
//       await axios.post('https://yepper-backend.onrender.com/api/auth/resend-verification', { email });
